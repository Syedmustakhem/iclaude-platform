...
export default {
  async fetch(
    ...
    if (
      ...
      return createUploadPresignRoute(request, env);
    }
    ...
    if (
      ...
      return confirmUploadRoute(request, env);
    }
    ...
    if (
      ...
      return createJobRoute(request, env);
    }
    ...
    if (
      ...
      return jobStatusRoute(request, env, jobId);
    }
